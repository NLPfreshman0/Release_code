...
if __name__ == '__main__':
    ...
    setup_device(args)
    setup_seed(args)
    matched_data = np.load('/data/zhangdacao/dataset/multi_nli/validation_matched.npy', allow_pickle='TRUE')
    mismatched_data = np.load('/data/zhangdacao/dataset/multi_nli/validation_mismatched.npy', allow_pickle='TRUE')
    ...
    np.save('/data/zhangdacao/dataset/multi_nli/matched_hard.npy', matched_hard)
    mismatched_hard = gen_hard(args, tokenizer, model, mismatched_data)
    np.save('/data/zhangdacao/dataset/multi_nli/mismatched_hard.npy', mismatched_hard)