...
def parse_args():
    ...
    parser.add_argument("--valid_steps", type=int, default=500, help="valid steps")
    ...
    parser.add_argument('--max_steps', default=30000, type=int, metavar='N', help='number of total epochs to run')
